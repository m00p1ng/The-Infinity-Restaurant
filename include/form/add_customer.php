<div class="ui small modal" id="new-customer-modal">
    <div class="header"><i class="user icon"></i>Add Customer</div>
    <div class="content">
        <div id="errorMsg-cust"></div>
        <div class="ui form">
            ...
            <div class="fields">
                <div class="seven wide field">
                    ...
                    <input type="text" name="card-number" id="card-number" maxlength="16" value="" required>
                </div>
                <div class="three wide field">
                    <label>CVC</label>
                    <input type="text" name="card-cvc" id="card-cvc" maxlength="3" value="" required>
                </div>
...
<div class="ui small modal" id="new-customer-complete">
